data:extend({
  ...
  },
 {
    ...
    selection_box = {{-0.5, -1.5}, {0.5, -0.5}},
    max_payload_size = 1,
    speed = 0.05,                                           -- normal basic speed
    max_energy = "1.5MJ",									-- no changes in battery capacity
    energy_per_tick = "0.045kJ",							-- 0.9x energy consumption per tick
    speed_multiplier_when_out_of_energy = 0.3,				-- a bit faster when discharged
    energy_per_move = "4.5kJ",								-- 0.9x energy consumption when moving
    min_to_charge = 0.2,
    max_to_charge = 0.95,
    idle =
    {
